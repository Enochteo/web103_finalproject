...
🔗 [Demo Video](./final_project.gif)

## Reflection

### 1. What went well during this unit?

Backend and frontend features came together: authentication and role-based flows work, uploads and resolution records are integrated, and the app was deployed to Render.

### 2. What were some challenges your group faced in this unit?

Environment/config issues (Vite env prefixes, DATABASE*URL vs PG*\*), Postgres SSL settings, password hashing/migration, and CORS/dev-proxy debugging.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

Working role-based dashboards (admin/technician), secure password handling, Supabase image uploads for resolutions, and a consistent UI across pages.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

I've improved full-stack debugging, environment/config management, and integrating third-party services (Supabase, Postgres) into a production workflow.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

Finish admin UX and pagination, add E2E tests, and learn CI/CD best practices; next steps: implement tests, finalize UI, and automate deploys.
